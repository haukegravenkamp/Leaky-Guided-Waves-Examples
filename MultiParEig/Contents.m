...
% 
% Toolbox contains numerical methods for multiparameter and singular 
...
% ------------------------------------------------------------------------
% 
% This is a joined work with Andrej Muhic, who wrote part of the code, 
...
% A. Muhic, B. Plestenjak: On the quadratic two-parameter eigenvalue 
...
% ------------------------------------------------------------------------
% We are looking for finite eigenvalues of a singular generalized
...
%  - support for rectangular multiparameter eigenvalue problems 
%  - new methods rect_multipareig, quad_rect_twopareig
%  - optimal parameter of ARMA(1,1), ARMA(2,1) AND LTI(2) models
%  - new methods arma11, arma21, lti2
%
% ------------------------------------------------------------------------
% Change log from version 2.5:
%  - improved method singgep for finite eigenvalues of singular pencils
%  - improved methods twopareig, threepareig, multipareig
%  - additional singular pencils examples in folder SingGep
%
% ------------------------------------------------------------------------
% Change log from version 2.4:
%  - new method singgep for finite regular eigenvalues of singular pencils
%  - new method singtwopar for singular 2EP
%  - singular pencils examples in folder SingGep
%
% ------------------------------------------------------------------------
% Change log from version 2.3:
%  - all methods now support multiprecision 
%  - new featues in threepareigs_jd, threepareigs_si and twopareigs_jd
%  - new 3-parameter examples in folder Subspace3
%  - minor fixes
%
% ------------------------------------------------------------------------
...
% - singtwopar: finite regular eigenvalues of a singular 2EP (alternative)
% 
...
% - singgep: finite regular eigenvalues of a singular pencil
% 
...
% 
% double_eig:
% A. Muhic, B. Plestenjak: A method for computing all values lambda such 
...
% singgep:
% M.E. Hochstenbach, C. Mehl, B. Plestenjak: Solving singular generalized 
% eigenvalue problems part II: projection and augmentation, arXiv:2208.01359
%
% rect_multipareig, rect_quad_twopareig, arma11, arma21, lti2
% M.E.Hochstenbach, T.Košir, B.Plestenjak: On the solution of rectangular 
% multiparameter eigenvalue problems, arXiv 2212.01867
% ------------------------------------------------------------------------
% 
% MultiParEig toolbox
