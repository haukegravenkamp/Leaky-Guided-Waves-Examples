...
[ll,ee,Xr,Yr,Xl,Yl,res,hist] = twopareigs_jd(A1,B1,C1,A2,B2,C2,10,OPTS);
toc

% -----------------------------------------------------------------------
% We use the computed eigenvectors as input for the second computation
% and compute 15 new eigenvalues (selection test prevents the method to
...
tic
[ll2,ee2,Xr2,Yr2,Xl2,Yl2,res2,hist2] = twopareigs_jd(A1,B1,C1,A2,B2,C2,15,OPTS);
toc
