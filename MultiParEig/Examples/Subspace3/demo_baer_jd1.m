%DEMO_BAER_JD1 Baer wave system is solved as a three-parameter eigenvalue problem 
% with Chebyshev collocation and Jacobi-Davidson (example 1)
%
...
%
% See also: DEMO_BAER_JD2, DEMO_BAER_SI1, DEMO_BAER_SI2
%
...
% parameters for the Jacobi-Davidson method
neig = 80;
opts = [];
opts.target = [0 0 0];
opts.M1 = [];
