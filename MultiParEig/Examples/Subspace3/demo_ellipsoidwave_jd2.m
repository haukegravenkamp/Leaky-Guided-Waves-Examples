%DEMO_ELLIPSOIDWAVE_JD2 Ellipsoidal wave system is solved as a three-parameter 
% eigenvalue problem with Chebyshev collocation and Jacobi-Davidson (example 2)
%
% This example returns Figure 5.1 (middle) and second part of Table 5.2 in 
% M. Hochstenbach, K. Meerbergen, E. Mengi, B. Plestenjak: 
% Subspace methods for 3-parameter eigenvalue problems, arXiv 1802:07386
% 
% See also: DEMO_ELLIPSOIDWAVE_JD1, DEMO_ELLIPSOIDWAVE_JD3, DEMO_ELLIPSOIDWAVE_SI2
...
% closest to 200 for the ellipsoid with semi-axes 1, 1.5, and 2 with a 
...
tic
disp('Computing eigenvalues (lambda,mu,eta) for N=300 with smallest |eta-200| using JD iteration...')
