%DEMO_ELLIPSOIDWAVE_SI1 Ellipsoidal wave system is solved as a three-parameter 
% eigenvalue problem with Chebyshev collocation and subspace-iteration (example 1)
%
% This example returns Figure 5.2 (left) and first part of Table 5.2 in 
% M. Hochstenbach, K. Meerbergen, E. Mengi, B. Plestenjak: 
% Subspace methods for 3-parameter eigenvalue problems, arXiv 1802:07386
% 
% See also: DEMO_ELLIPSOIDWAVE_SI2, DEMO_ELLIPSOIDWAVE_SI3, DEMO_ELLIPSOIDWAVE_JD1
...
tic
fprintf('Computing eigenvalues (lambda,mu,eta) for N=%d with smallest |eta| using subspace iteration...\n',N)
