%DEMO_ELLIPSOIDWAVE_SI2 Ellipsoidal wave system is solved as a three-parameter 
% eigenvalue problem with Chebyshev collocation and subspace-iteration (example 2)
%
% This example returns Figure 5.2 (middle) and second part of Table 5.2 in 
% M. Hochstenbach, K. Meerbergen, E. Mengi, B. Plestenjak: 
% Subspace methods for 3-parameter eigenvalue problems, arXiv 1802:07386
% 
% See also: DEMO_ELLIPSOIDWAVE_SI1, DEMO_ELLIPSOIDWAVE_SI3, DEMO_ELLIPSOIDWAVE_JD2
...
% smallest |eta-200| for the ellipsoid with semi-axes 1, 1.5, and 2 with a 
...
%   - we limit delta matrices to size 5000 (we need larger sizes as for target=0)
...
shifteta = 200; % we are looking for eigenvalues such that [eta-shifteta| is minimal
shiftlambda = -5; % we use this shift to make matrices A_i nonsingular
