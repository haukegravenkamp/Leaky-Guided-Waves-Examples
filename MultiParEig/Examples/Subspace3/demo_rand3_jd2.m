%DEMO_RAND3_JD2 Random three-parameter eigenvalue problem is solved
% with Jacobi-Davidson for target eta=-0.5 (example 1)
%
% See also: DEMO_RAND3_JD2, DEMO_RAND3_JD3
%
% We use a random generated 3-parameter eigenvalue problem with 100 x 100 
% matrices and compute eigenvalues with the smallest |eta+0.5|. 
...
shifteta = -0.5; % we are looking for eigenvalues such that [eta-shift| is minimal
...
tic
disp('Computing 50 eigenvalues (lambda,mu,eta) with smallest |eta+0.5| for the random 3-parameter problem with N=100 using J-D...')
...
% notice that mildly interior eigenvalues are more difficult to compute
indices