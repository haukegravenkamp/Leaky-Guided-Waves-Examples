...
% BP 17.12.2023 : initial norm of Delta matrices option for staircase steps
...
if isfield(opts,'initialnorms'),  initialnorms = opts.initialnorms;   else, initialnorms=[0 0 ];   end
...
opts.rrqr = rrqr*2;
opts.initialnorm = initialnorms(1);
...
opts.rrqr = rrqr*1;
opts.initialnorm = initialnorms(2);
