...
%
% [lambda,mu,eta,x,y,z,res,flag,iter] = trqi_3p(A1,B1,C1,D1,A2,B2,C2,D2,A3,B3,C3,D3,x0,y0,z0,maxiter,tol)
...
%   - tol : tolerance for the residual (default is 1e6*eps)
%
% Output:
